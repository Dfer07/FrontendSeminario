(() => {
  ...
  const state = { editingId: null, apiBase: localStorage.getItem('https://backendseminario-1hmu.onrender.com') || 'https://backendseminario-1hmu.onrender.com' }
  ...
  function setApiBase(value) {
    ...
    localStorage.setItem('https://backendseminario-1hmu.onrender.com', state.apiBase)
